...
```
triviaapi2 <command> [arguments] [flags]
```

Run `triviaapi2 <command> --help` for the full flag list on any command. This
...
per operation you declare in `triviaapi2/domain.go`.
