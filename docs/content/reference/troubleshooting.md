...
Most of these come down to network reality or how triviaapi2 serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

triviaapi2 rate-limits like any public site. triviaapi2 already paces
...
Where a surface is gated, triviaapi2 reads a cookie or token you supply
...
`triviaapi2`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what triviaapi2 actually did
