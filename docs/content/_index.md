---
title: "triviaapi2"
description: "A command line for triviaapi2."
heroTitle: "triviaapi2, from the command line"
heroLead: "A command line for triviaapi2. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
triviaapi2 links <path>           # the pages it links to, each addressable
triviaapi2 serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading triviaapi2 by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address triviaapi2 as
  `triviaapi2://` URIs and follow links across sites. See
