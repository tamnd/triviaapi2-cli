...
// HTTP behaviour is covered in triviaapi2_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "triviaapi2://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("triviaapi2", "about")
	if err != nil || got.String() != "triviaapi2://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want triviaapi2://page/about", got.String(), err)
	}
}
